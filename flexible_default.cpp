...
int main()
{
    ...
    std::cout<< "symmetry=" << in_1.symmetry.value << ", mixing_beta=" << in_1.mixing_beta.value << std::endl;
    ...
    std::cout<< "symmetry=" << in_2.symmetry.value << ", mixing_beta=" << in_2.mixing_beta.value << std::endl;
    ...
    std::cout<< "symmetry=" << in_3.symmetry.value << ", mixing_beta=" << in_3.mixing_beta.value << std::endl;
